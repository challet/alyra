...
const dix_minutes = 60 * 1000; // en ms
...
console.log(`Entre le ${timestamp.toLocaleString('fr-FR', date_locale_config)} et le ${maintenant.toLocaleString('fr-FR', date_locale_config)}, ${nb_blocs.toLocaleString('fr-FR')} blocs ont été créés. La taille totale des en-têtes est ${(poids / mo).toLocaleString('fr-FR')} Mo.`)
